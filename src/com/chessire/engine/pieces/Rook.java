...
// Very similar to a Bishop. Only the exclusion conditions are different, as defined at the end.
public class Rook extends Piece {

    private  final static int[] CANDIDATE_COORDINATE_MOVE_VECTOR_COORDINATES = {-8, -1, 1, 8};
    ...
    private static boolean isFirstColumnExclusion(final int currentPosition, final int candidateOffset){
        return BoardUtils.isValidTileCoordinate(currentPosition) && (candidateOffset == -1);
    }
